                            ...
                            <div class="single_f_widget p-t-3 wow fadeInUp">
                                ...
                                <div class="single_f_widget_text">
                                    ...
                                    <div class="socail_f_widget">
                                        <a href="https://www.facebook.com/masum.update" ><i class="fa fa-facebook"></i></a>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <div class="copyright_text m-t-2 text-xs-center">
                                <p class="wow zoomIn" data-wow-duration="1s">Made with <i class="fa fa-heart"></i> by <a target="_black" href="http://bootstrapthemes.co"> BrandHex Hybrid</a> 2016. All Rights Reserved</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
